      ...
      <div className=' w-full bg-[url("/hero1.jpg")]  min-h-[300px] bg-cover bg-center'>
        ...
        >
          <div className="  h-full flex-col justify-center items-center hidden lg:flex col-span-1">
            ...
            Place your order with confidence. Got a question? Just ask! We guarantee your task is completed flawlessly and delivered before your deadline.
            </p>
          </div>
          <InputBox courses={courses} />
        </div>
        <div className=" w-full relative flex flex-col gap-y-4 lg:hidden">
