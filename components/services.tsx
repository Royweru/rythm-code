  ...
  return (
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold leading-tight text-blue-dark1 sm:text-4xl xl:text-5xl  font-gothic">Services we offer</h2>
            <p className="mt-2 text-base leading-7  text-gray-500 ">Lorem ipsum dolor sit amet, consectetur adipis elit</p>
        </div>
